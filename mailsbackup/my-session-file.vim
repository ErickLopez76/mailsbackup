...
set shortmess=aoO
badd +1 mainback.py
badd +1 mailsbackuptools.py
badd +1 confdata.py
badd +1 config.ini
badd +1 setuser.py
badd +1 versioncontrol.py
argglobal
silent! argdel *
argadd mainback.py
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 25 - ((8 * winheight(0) + 14) / 29)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 14 - ((11 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
14
...
216
normal! zo
let s:l = 225 - ((23 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
225
...
88
normal! zo
let s:l = 11 - ((7 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
11
